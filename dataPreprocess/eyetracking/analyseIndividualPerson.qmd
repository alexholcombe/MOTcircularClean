...
fixatnsAndCorrectn<-fixatnsAndCorrectn %>% mutate(
            distCorrected = sqrt( (xDevCorrectd)^2 + (yDevCorrectd)^2 )
         )
```
...
fixatnsAndCorrectn$xDev <- fixatnsAndCorrectn$xDev - widthPix/2
fixatnsAndCorrectn$yDev <- fixatnsAndCorrectn$yDev - heightPix/2
