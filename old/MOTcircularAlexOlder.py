...
eyetracking = False; eyetrackFileGetFromEyelinkMachine = True #very timeconsuming to get the file from the Windows machine over the ethernet cable, 
#could be better to get the EDF file from the Eyelink machine by hand by rebooting into Windows and going to 
...
numObjsInRing =         [  2,                    8        ]
speedsEachNumObjs =  [ [0.5, 1.0], [0.5, 1.0 ] ]   #[ [0.5,1.0,1.4,1.7], [0.5,1.0,1.4,1.7] ]     #dont want to go faster than 2 because of blur problem
