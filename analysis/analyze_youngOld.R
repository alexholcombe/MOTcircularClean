...
#Get age and sex info sheet - an anonymised copy of the Sharepoint participant sheet with many columns 
...
#Exclude timingBlips. What does the preregistration say?
#Some early participants didn't have separate numLongFramesAfterCue or even numLongFramesAfterFixation
