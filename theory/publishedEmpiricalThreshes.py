...
threshHzPrevLit = { 'numTargets': [1,2,3],
                    'HzRoudaiaFaubertYoungMen': [6.4, 4, 2.8],
                    'HzRoudaiaFaubertYoungWomen': [4.9, 3, 1.8],
                    'HzHolcombeChenE1': [7.1, 4.45, None],
                    'HzHolcombeChenE2': [None,4.05,2.7]       }
