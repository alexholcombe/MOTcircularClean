...
# set to zero for Yes/No (or PSE). Set to 0.5 for 2AFC. PROBLEM: that often yeilds a divide by zero error during data fitting
expectedMin = 0.4
...
try:
    ...
    print("When trying to fit data, an exception occurred:", str(e))
    fitFailed = True       
